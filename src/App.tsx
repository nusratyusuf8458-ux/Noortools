...
export default function App() {
  ...
  return <div className="app">
    ...
    <header className="topbar"><button className="brand" onClick={() => navigate('home')} aria-label={view === 'home' ? 'NoorTools home ready' : 'NoorTools home'}><span className="mark">ن</span><span><b>NoorTools</b><small>Islamic companion</small></span></button><button onClick={() => navigate('settings')} aria-label="Settings">⚙</button></header>
    <main>
